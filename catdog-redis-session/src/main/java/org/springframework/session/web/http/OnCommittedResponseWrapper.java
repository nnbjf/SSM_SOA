 ...
 * the {@link HttpServletResponse} is committed.
 *
 * @author Rob Winch
 * @since 1.0
 */
abstract class OnCommittedResponseWrapper extends HttpServletResponseWrapper {
	 ...
	 * {@link HttpServletResponse} is committed. This can be useful in
	...
	/**
	 * Implement the logic for handling the {@link HttpServletResponse}
	 * being committed.
	 */
	 ...
	 * the original {@link PrintWriter} to ensure that the behavior is as close to
	 * the original {@link PrintWriter} as possible. See SEC-2039
	 * @author Rob Winch
	 */
	 ...
	 * {@link ServletOutputStream} to ensure that the behavior is as close
	 * to the original {@link ServletOutputStream} as possible. See SEC-2039
	 *
	 * @author Rob Winch
	 */
